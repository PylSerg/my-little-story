...
export default function LoginScreen({
	...
	const goToRegistrationScreen = () => navigate("Registration");
			...
			<View style={styles.container}>
				<ImageBackground style={styles.background} source={require("../../assets/images/background.jpg")}>
					<View style={styles.signInBlock}>
						...
						<TouchableOpacity style={[CommonStyles.button, styles.signInButton]} onPress={submitForm}>
							<Text style={CommonStyles.buttonTitle}>Sign in</Text>
						</TouchableOpacity>
